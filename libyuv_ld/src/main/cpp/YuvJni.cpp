...
#define YUV_UTILS_JAVA "com/example/sweeper/libyuv_ld/YuvUtils"
...
int i420ToRgb24(JNIEnv *env, jclass clazz, jbyteArray yuv, jint y_stride, jint u_stride, jint v_stride,
            jbyteArray rgba, jint rgba_stride, jint width, jint height,
            int (*func)(const uint8 *, int, const uint8 *, int, const uint8 *, int, uint8 *,
                        int, int, int)) {
    size_t ySize = (size_t) (y_stride * height);
